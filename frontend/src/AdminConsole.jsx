    ...
    <div className="admin-console">
      <section className="admin-hero">
        <div>
          ...
          <p>Manage system configuration, roles, requirement rules, imports, exports, and audit visibility.</p>
        </div>
      ...
      <section className="grid two">
        <AdminCard title="User & Role Management">
          <table>
            ...
            <tbody>{users.map(u => <tr key={u.email}><td><strong>{u.name}</strong><br/><span>{u.email}</span></td><td>{u.role}</td><td><span className="admin-pill">{u.status}</span></td></tr>)}</tbody>
          </table>
        </AdminCard>
        ...
        <AdminCard title="Requirement Catalog">
          <table>
            ...
            <tbody>{requirements.map(r => <tr key={r.name}><td><strong>{r.name}</strong></td><td>{r.category}</td><td>{r.appliesTo}</td><td><span className="admin-pill">{r.status}</span></td></tr>)}</tbody>
          </table>
        </AdminCard>
      </section>
