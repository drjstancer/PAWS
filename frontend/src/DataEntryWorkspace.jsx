    ...
    <div className="data-entry-workspace">
      <section className="admin-hero">
        <div>
          ...
          <p>Use this workspace to model how staff would enter students, advising notes, course records, compliance updates, and import batches.</p>
        </div>
      ...
      <section className="grid two">
        <DemoForm title="Student Intake" description="Create or update a student profile.">
        ...
        <DemoForm title="Advising Note" description="Document required meetings and follow-up needs.">
          <div className="form-grid two-col">
      ...
      <section className="grid two">
        <DemoForm title="Course & GPA Entry" description="Enter course records used by the GPA calculation engine.">
          <div className="form-grid two-col">
          ...
          <div className="check-row"><label><input type="checkbox" /> Counts toward science/math GPA</label><label><input type="checkbox" /> Repeat course</label></div>
          <button className="btn-like" onClick={() => fakeSave('Course record')}>Save Course</button>
        </DemoForm>

        <DemoForm title="Compliance Status Update" description="Update requirement completion, waiver, or follow-up status.">
          <div className="form-grid two-col">
            <label>Student<select><option>Aaliyah Brooks</option><option>Marcus Carter</option><option>Elijah Reed</option></select></label>
      ...
      <section className="demo-card">
        ...
        <p className="muted-copy">Bulk imports would allow staff to upload student lists from Excel/CSV. The production system validates MU ID, required fields, GPA ranges, RUCA codes, and cohort year before saving.</p>
...
function DemoForm({ title, description, children }) {
  return (
